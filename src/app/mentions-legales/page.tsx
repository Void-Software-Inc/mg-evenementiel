...
export default function MentionsLegalesPage() {
  return (
    <>
      ...
      <div className="h-full w-full flex flex-col justify-center items-center my-32">
      <div className="w-[85%] flex flex-col justify-center items-center">
      <h1 className='text-center text-zinc-800 mb-8 sm:mb-20 text-6xl sm:text-7xl md:text-8xl font-thin tracking-tight block'>MENTIONS LÉGALES</h1>
        <div className="w-full max-w-4xl">
          
        <section className="mb-12">
            <h2 className="text-2xl font-light mb-6 text-zinc-800">Bienvenue sur notre site web</h2>
            <p className="mb-2">
              Conformément à <a 
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-light mb-6 text-zinc-800">Informations sur l'entreprise</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-light mb-6 text-zinc-800">Éditeur du site</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-light mb-6 text-zinc-800">Hébergement</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-light mb-6 text-zinc-800">Propriété intellectuelle</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-light mb-4 text-zinc-800">Images du catalogue</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-light mb-4 text-zinc-800">Photos de la page "Réalisations"</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-light mb-4 text-zinc-800">Image libre de droits dans le menu</h3>
                  <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-light mb-6 text-zinc-800">Gestion des données personnelles (RGPD)</h2>
            <div className="mb-6">
    <h3 className="text-xl font-light mb-4 text-zinc-800">Collecte et traitement des données</h3>
    <p className="mb-4">
  ...
  <div className="mb-6">
    <h3 className="text-xl font-light mb-4 text-zinc-800">Droits des utilisateurs</h3>
    <p className="mb-3">
  ...
  <p className="text-sm">
    ...
    >
      mgevenementiel31@gmail.com
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-light mb-6 text-zinc-800">Limitation de responsabilité</h2>
            <div className="space-y-4">
              <p>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-xl font-light mb-4 text-zinc-800">Types de cookies utilisés</h3>
                <p className="mb-2">
              ...
              <div>
                <h3 className="text-xl font-light mb-4 text-zinc-800">Consentement</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl font-light mb-4 text-zinc-800">Gestion des cookies</h3>
                <p className="mb-3">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-light mb-6 text-zinc-800">Conditions générales d'utilisation du site (CGU)</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-light mb-4 text-zinc-800">Accès au site</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-light mb-4 text-zinc-800">Services proposés</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-light mb-4 text-zinc-800">Modifications</h3>
                  <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-light mb-6 text-zinc-800">Droit applicable et attribution de juridiction</h2>
