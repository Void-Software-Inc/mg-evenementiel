...
const Footer = () => {
  return (
  <div className="h-fit w-full bg-zinc-950 flex flex-col justify-center items-center py-8 lg:pt-24">
    <div className='h-fit w-[90%] bg-transparent flex flex-col lg:flex-row justify-between items-start'>

    <div className="space-y-4 flex-1 max-w-[400px]">
        <p className="text-2xl lg:text-4xl text-white font-extralight">NAVIGATION</p>
      ...
      <div className="space-y-4 flex-1 max-w-[350px]">
        <p className="text-2xl lg:text-4xl text-white font-extralight">CONTACT</p>
        <div className="text-lg lg:text-xl text-white font-extralight flex flex-col space-y-2">
      ...
      <div className="space-y-4 flex-1 max-w-[400px] text-end">
        <p className="text-2xl lg:text-4xl text-white font-extralight  ">MG ÉVÉNEMENTS</p>
        <div className="text-lg lg:text-xl text-white font-extralight">
          <p className="text-base font-thin">Adresse de récupération :</p>
          <Link href="https://maps.google.com/?q=Chemin+des+droits+de+l'homme+et+du+citoyen,+31450+Ayguevives" target="_blank" className="text-base font-thin">
            Chemin des droits de l'homme et du citoyen,
          </Link>
          <p>31450 Ayguevives</p>
        </div>
        <img
    ...
    <div className='w-[90%] flex justify-between mt-20'>
      ...
      <Link href="/mentions-legales" passHref>
        <p className='text-white hover:text-gray-400 transition-colors ease-in-out duration-300 text-base font-extralight'>Mentions légales</p>
      </Link>
