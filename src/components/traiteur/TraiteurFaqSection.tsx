...
const TraiteurFaqSection = () => {
    ...
    const faqItems = [
        ...
        },
        {
            ...
            answer: "Vous pouvez remplir notre formulaire de contact en ligne ou nous écrire directement par mail. Une réponse vous sera apportée sous 48h ouvrées."
        },
        {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="flex items-start justify-start">
                        <div className="text-left space-y-4 pt-4">
                            <p className="text-2xl sm:text-3xl font-extralight text-gray-800">
                        ...
                        <div className="space-y-1">
                            {faqItems.map((item, index) => (
                                <div key={index} className="rounded-none border-b border-gray-200">
                                    ...
                                    >
                                        <h4 className="text-lg sm:text-xl font-light text-gray-900 pr-4">{item.question}</h4>
                                    ...
                                    >
                                        <p className="text-base font-light px-4 pt-2 pb-4 text-gray-700">
                                            {item.answer}
                                        </p>
                                    </div>
                                </div>
